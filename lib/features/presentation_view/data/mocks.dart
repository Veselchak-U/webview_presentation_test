...
class Mocks {
  final presentationsMock = [
    ...
    const PresentationEntity(
      id: 'id_koselugo_2023_2',
      url:
          'https://drive.google.com/uc?export=download&confirm=no_antivirus&id=1rTiecXCFHpdnItFZT1euvQNIQqMu173o',
      fileName: 'koselugo_2023_2.zip',
      name: 'koselugo_2023_2',
    ),
  ];
}
